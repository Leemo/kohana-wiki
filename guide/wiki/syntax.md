...
Link to Some Page, with a different text: [[Some page|Differerent text]]
~~~
...
[!!] Note that the images in wiki are [namespaced](#namespacing).
...
For more information see [Internal wiki links](#internal-wiki-links)